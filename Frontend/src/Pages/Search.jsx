...
const Search = () => {
    return (
        ...
        <form className="text-center">
          ...
          <div className="flex mb-4">
            <label htmlFor="filter" className="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Filter: </label>
            <select id="filter" name="filter" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
              <option value="">None</option>
