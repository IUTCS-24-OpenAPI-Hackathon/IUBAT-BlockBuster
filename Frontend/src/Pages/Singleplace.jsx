          ...
          <div className="col-md-4">
            <div className="card-body">
              ...
              <div className='flex align-middle'>
                <FaLocationDot className='mr-2 mt-1' /> Address: {a.properties.address_line2}
              </div>
              <p className="card-text"></p>
            </div>
          </div> <br />
          <div className=''>
            <Link to={`/nearbyPlaces/${a.properties.place_id}`} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Details</Link>
          </div>
        </div>
      </div>
    </div>
